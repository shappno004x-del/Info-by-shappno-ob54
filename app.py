...
def get_full_info():
    ...
    response = {
        ...
        "BasicInformation": {
            "PrimeLevel": basic.get("primeLevel", {}).get("level", "N/A"),
        ...
        "ActivityInformation": {
            ...
            "CSRank": get_cs_rank_name(basic.get("csRankingPoints", 0)),
            "CSPoints": basic.get("csRankingPoints", 0),
        ...
        "LeaderInformation": {
            ...
            "CSRank": get_cs_rank_name(captain.get("csRankingPoints", 0)),
            "CSPoints": captain.get("csRankingPoints", 0)
        }
    }
